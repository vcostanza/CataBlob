...
/**
 * A simple image viewer widget that supports panning and zooming
 * Github: https://github.com/k1slay/ZoomImageView
 * @author Kislay [k.two.apps@gmail.com]; Cleaned up for CataBlob
 * @since 03/09/20
 */
class ZoomImageView @JvmOverloads constructor(
    ...
    init {
        ...
        tapDetector = GestureDetector(context, object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onScroll(
                ...
                if (currentScale <= MIN_SCALE) {
                    if (swipeToDismissEnabled && yAbs > xAbs) {
                        ...
                        dismissProgressListener(dismissProgress)
                    }
                } else {
            ...
            override fun onDown(e: MotionEvent?): Boolean {
                ...
                preEventImgRect.set(displayRect)
    ...
    private inline val drawableWidth get() = drawable?.intrinsicWidth ?: 0

    private inline val drawableHeight get() = drawable?.intrinsicHeight ?: 0
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (debugInfoVisible) {
            ...
            canvas.drawText("Drawable: $displayRect", 10F, 40F, textPaint)
        }
    }
    ...
    private fun animatePan(startX: Float, startY: Float, endX: Float, endY: Float,
            ...
            addUpdateListener {
                ...
                dismissProgress?.let { progress ->
                    if (1.0F - it.animatedFraction < progress) {
                        dismissProgressListener(1.0F - it.animatedFraction)
                    }
                }
            }
            interpolator = zoomInterpolator
